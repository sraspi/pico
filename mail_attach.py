def send_csv(Zeit, temperature):
    ...
    while counter < 5:
        ...
        try:
            test1 = smtp.login('sraspi21@gmail.com', 'rwnqyynanebneqbj')
            ...
            if (result != -1): # meaning: if result!=-1>>then False
                ...
                time.sleep(1)
                smtp.write("From: sraspi <sraspi21@gmail.com>\n")
                smtp.write("To: stefan <stefan.taubert.apweiler@gmail.com>\n")
                smtp.write('Subject: Today\'s datalog.tct\n')
